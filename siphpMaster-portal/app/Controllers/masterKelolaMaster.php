...
class masterKelolaMaster extends BaseController
{
    ...
    public function masterPekerjaan()
    {
        ...
        if ($keyword) {
            $list_pekerjaan = $this->masterPekerjaanModel->search($keyword);
        } else {
            $list_pekerjaan = $this->masterPekerjaanModel->getAllPegawai();
            // dd($list_pekerjaan);
        }
    ...
    public function tambahPekerjaan()
    {
        ...
        $this->masterPekerjaanModel->insert([
            'kdes3' => $this->request->getVar('es3_kd'),
            'kdes4' => $this->request->getVar('es4_kd'),
